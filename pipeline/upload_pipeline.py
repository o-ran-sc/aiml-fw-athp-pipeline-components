...
if __name__ == "__main__":
    ...
    try:
        resp = requests.post(
            "http://192.168.180.52:32002/pipelines/{}/upload".format(args.pipeline_name),
            files={"file": open(args.pipeline_file, "rb")},
        )

            # Log the response status code and content
        logging.info(f"Request URL: http://192.168.180.52:32002/pipelines/{args.pipeline_name}/upload")
